...
`define tCONV     			32 //26  // tCONV: type 1.3 us, MAX 1.6 us, 1600/50(assumed clk is 20mhz)=32  -> 1.3us/50ns = 26
                              // set 32 for suite for 1.6 us max
//                         +12 //data

`define tHCONVST           16 // 6  // here set 320（ fsample = 333KHz） for if ADC input impedance is high, see below  
                                ...
                                //Otherwise, more acquisition time should be allowed for a source with higher impedance.
										  ...
										  // for acheiving 400KHz  fmax. set n cyc = 50.
