...
# ----------------------------------------
# If FIR_II is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2026.06.17.11:25:26
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/FIR_II_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FIR_II_rtl_core_u0_m0_wo0_wi0_r0_ra0_count1_lut_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/FIR_II_rtl_core.vhd"                            
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/FIR_II_ast.vhd"                                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/FIR_II.vhd"                                     
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/FIR_II_tb.vhd"                                  
}
