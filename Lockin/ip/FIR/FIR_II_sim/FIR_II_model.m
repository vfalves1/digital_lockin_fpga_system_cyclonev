...
% ================================================================================
% Generated on: 06/17/2026 11:25:24
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = FIR_II_mlab(single_channel_data{i}, single_channel_bank{i});
