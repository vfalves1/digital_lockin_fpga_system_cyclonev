...
module soc_system (
	...
	memory_mem_dm,
	memory_oct_rzqin,
	pio_fase_external_connection_export,
	pio_freq_external_connection_export,
	pio_magnitude_external_connection_export,
	reset_reset_n);	
	...
	output		adc_0_external_sclk;
	output		adc_0_external_cs_n;
	input		adc_0_external_dout;
	output		adc_0_external_din;
	...
	input	[31:0]	pio_fase_external_connection_export;
	input	[31:0]	pio_freq_external_connection_export;
	input	[31:0]	pio_magnitude_external_connection_export;
	input		reset_reset_n;
endmodule
