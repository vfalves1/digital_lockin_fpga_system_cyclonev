	component soc_system is
		port (
			...
			adc_0_external_sclk                      : out   std_logic;                                        -- sclk
			adc_0_external_cs_n                      : out   std_logic;                                        -- cs_n
			adc_0_external_dout                      : in    std_logic                     := 'X';             -- dout
			adc_0_external_din                       : out   std_logic;                                        -- din
			...
			pio_fase_external_connection_export      : in    std_logic_vector(31 downto 0) := (others => 'X'); -- export
			pio_freq_external_connection_export      : in    std_logic_vector(31 downto 0) := (others => 'X'); -- export
			pio_magnitude_external_connection_export : in    std_logic_vector(31 downto 0) := (others => 'X'); -- export
	...
	u0 : component soc_system
		port map (
			...
			adc_0_external_sclk                      => CONNECTED_TO_adc_0_external_sclk,                      --                    adc_0_external.sclk
			adc_0_external_cs_n                      => CONNECTED_TO_adc_0_external_cs_n,                      --                                  .cs_n
			adc_0_external_dout                      => CONNECTED_TO_adc_0_external_dout,                      --                                  .dout
			adc_0_external_din                       => CONNECTED_TO_adc_0_external_din,                       --                                  .din
			...
			pio_fase_external_connection_export      => CONNECTED_TO_pio_fase_external_connection_export,      --      pio_fase_external_connection.export
			pio_freq_external_connection_export      => CONNECTED_TO_pio_freq_external_connection_export,      --      pio_freq_external_connection.export
			pio_magnitude_external_connection_export => CONNECTED_TO_pio_magnitude_external_connection_export, -- pio_magnitude_external_connection.export
