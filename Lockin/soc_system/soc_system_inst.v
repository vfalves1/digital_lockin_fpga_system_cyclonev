	soc_system u0 (
		...
		.adc_0_external_sclk                      (<connected-to-adc_0_external_sclk>),                      //                    adc_0_external.sclk
		.adc_0_external_cs_n                      (<connected-to-adc_0_external_cs_n>),                      //                                  .cs_n
		.adc_0_external_dout                      (<connected-to-adc_0_external_dout>),                      //                                  .dout
		.adc_0_external_din                       (<connected-to-adc_0_external_din>),                       //                                  .din
		...
		.pio_fase_external_connection_export      (<connected-to-pio_fase_external_connection_export>),      //      pio_fase_external_connection.export
		.pio_freq_external_connection_export      (<connected-to-pio_freq_external_connection_export>),      //      pio_freq_external_connection.export
		.pio_magnitude_external_connection_export (<connected-to-pio_magnitude_external_connection_export>), // pio_magnitude_external_connection.export
