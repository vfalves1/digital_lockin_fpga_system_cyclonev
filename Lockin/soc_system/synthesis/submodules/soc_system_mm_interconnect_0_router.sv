...
(
    ...
    // -------------------------------------------------------
    localparam PAD0 = log2ceil(64'h110 - 64'h100); 
    localparam PAD1 = log2ceil(64'h120 - 64'h110); 
    localparam PAD2 = log2ceil(64'h310 - 64'h300); 
    localparam PAD3 = log2ceil(64'h320 - 64'h310); 
    localparam PAD4 = log2ceil(64'h330 - 64'h320); 
    ...
    // ( 0x110 .. 0x120 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 19'h110   ) begin
            src_channel = 12'b000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x300 .. 0x310 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 19'h300  && read_transaction  ) begin
            src_channel = 12'b010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x310 .. 0x320 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 19'h310  && read_transaction  ) begin
            src_channel = 12'b001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x320 .. 0x330 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 19'h320  && read_transaction  ) begin
