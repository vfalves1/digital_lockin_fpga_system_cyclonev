...
(
    ...
    localparam PAD6 = log2ceil(64'h158 - 64'h150); 
    ...
    // ( 0x300 .. 0x310 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 18'h300  && read_transaction  ) begin
            src_channel = 12'b00000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x310 .. 0x320 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 18'h310  && read_transaction  ) begin
            src_channel = 12'b00000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x320 .. 0x330 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 18'h320  && read_transaction  ) begin
